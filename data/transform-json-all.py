...
#
index   = dataHandler.read_country_names(filter=countryFilter)
...
file = dataHandler.get_transform_file("all", extension=".json")
...
json = { 'countries' : countries }
file = dataHandler.get_transform_file("all-best", extension=".json")
dataHandler.write_json(json, file)
...
json = { 'countries' : countries }
file = dataHandler.get_transform_file("all-worst", extension=".json")
dataHandler.write_json(json, file)
...
json = { 'countries' : countries }
file = dataHandler.get_transform_file("all-best-avg", extension=".json")
dataHandler.write_json(json, file)
...
json = { 'countries' : countries }
file = dataHandler.get_transform_file("all-worst-avg", extension=".json")
dataHandler.write_json(json, file)
